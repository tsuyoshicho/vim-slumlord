...
execute join(['function! vital#_slumlord#Vim#Buffer#Writer#import() abort', printf("return map({'replace': '', '_vital_created': '', '_vital_healthcheck': '', 'new': ''}, \"vital#_slumlord#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
